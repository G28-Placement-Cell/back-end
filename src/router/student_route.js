...
const { auth_student, register_student, log_out_student, login_student, get_student_profile, update_student_profile, get_all_job_profiles, change_password, reject, verify, getregstudent, getpenstudent } = require('../controller/student_control');
